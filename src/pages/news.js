...
const NewsPage = () => (
    <div className = "content news-content">
        ...
        <p className = "blog-content">If you're reading this immediately after launch, you might notice that there aren't any tournaments in the "Past Tournaments" section. This is the location where, after a tournament ends, anyone who is interested can find results in the form of links to bracket pics and a list of the top 3 teams in each division. In the past, results have faded into the wind after tournaments, and if you wanted information about a tournament that happened a while ago, you would have to search high and low. Now, with Spikehub, everything will be in one place.</p>
        ...
        <p className = "blog-content">If you've made it this far, thank you so much for taking the time to look into Spikehub. I'm incredibly excited to be releasing it, and I hope that you enjoy using it as much as I enjoyed making it. If you want to stay up to date with what's coming up or even just say "hi", go ahead and follow Spikehub on instagram @thespikehub. See you at the next tournament!</p>
